...
В рамках практического занятия №8 (24) на базе проекта `MIREA-TIP-Practice-24` реализован полноценный CI/CD пайплайн с использованием GitHub Actions. Пайплайн автоматизирует процессы тестирования, сборки Docker-образов и деплоя на удалённый сервер.
